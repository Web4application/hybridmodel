...
MODELS = [
ModelInfo(repo="web4application/Chatgpt-5"),
ModelInfo(repo="web4application/gpt-5-mini"),
ModelInfo(repo="web4application/enclov-AI"),
ModelInfo(repo="meta-llama/Llama-2-70b-chat-hf"),
ModelInfo(repo="stabilityai/StableBeluga2"),
ModelInfo(repo="seriki/llama-65b-hf"),
ModelInfo(repo="enoch/llama-65b-hf", adapter="timdettmers/guanaco-65b"),
ModelInfo(repo="bigscience/bloomz"),
# Add more models 
ModelInfo(repo="web4application/ollamab"),
ModelInfo(repo="web4application/lmlm"),
  ModelInfo(repo="web4application/universal-intelligence"),
  ModelInfo(repo="web4application/ollama"),
  ModelInfo(repo="web4application/Model")
ModelInfo(repo="web4application/rda"), adapter="lmlm"
ModelInfo(repo="kubu-hai.model.h5-2", adapter="kubu-hai.model.mat-2"),
ModelInfo(repo="kubu-hai.model.y5", adapter="kubu-hai.model.mat"),
]
DEFAULT_MODEL_NAME = "lmlm/hybrid"

INITIAL_PEERS = PUBLIC_INITIAL_PEERS
# Set this to a list of multiaddrs to connect to a private swarm instead of the public one, for example:
# INITIAL_PEERS = ['/ip4/10.0.0.1/tcp/31234/p2p/QmcXhze98AcgGQDDYna23s4Jho96n8wkwLJv78vxtFNq44']
